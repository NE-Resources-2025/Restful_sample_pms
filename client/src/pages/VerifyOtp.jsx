      ...
      <div className="w-full md:w-1/2 bg-white rounded-t-3xl md:rounded-l-3xl md:rounded-tr-none p-8 md:p-12 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-green-800 hover:bg-orange-700 text-white py-3 px-4 rounded-lg font-medium shadow-sm transition-colors duration-300"
            >
              Verify OTP
            </button>
          </form>
          ...
          <div className="mt-6 text-center space-y-4">
            <p className="text-sm text-gray-500">
              ...
              <button
                ...
                className="text-green-800 hover:text-orange-700 font-medium"
              >
                Resend OTP
              </button>
            </p>
